...
import { useCreateMenu, useDeleteMenu, useGetMenu, useUpdateMenu } from "@/services/useMenuService";
...
export const Menu = () => {
    ...
    const handleEditMenu = (id: number) => {
        const menuToEdit = getMenu.menus.find(
            (menu: any) => menu.id === id
        );
        if (menuToEdit) {
            setData({
